            ...
            <Card className="p-8 shadow-elevation-medium">
              <CardContent className="p-0">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  To advance robotics through innovative design, rigorous engineering, and collaborative teamwork. 
                  We are committed to developing systems that excel in competitions while fostering creativity and 
                  continuous learning. Through our efforts, we aim to inspire future engineers and make a lasting 
                  impact on society.
                </p>
              </CardContent>
            </Card>
